...
class LogisticRegressor:
    ...
    def fit(
        ...
        - ElasticNet regularization: Combines L1 and L2 penalties.
            ...
            dw_j += l1_ratio * gradient_of_lasso + \
                (1 - l1_ratio) * gradient_of_ridge
    ...
    def predict(self, X, threshold=0.5):
        ...
        classification_result = np.array(
            [0 if i < threshold else 1 for i in probabilities])
    ...
    def elasticnet_regularization(self, dw, m, C, l1_ratio):
        ...
        elasticnet_gradient = l1_ratio * (C / m) * np.sign(self.weights) + \
